...
FROM '/Users/alexnorvani/SDC-Info/SDC/reviews.csv'
DELIMITER ','
CSV HEADER;
...
FROM '/Users/alexnorvani/SDC-Info/SDC/characteristics.csv'
DELIMITER ','
CSV HEADER;

COPY photos (photo_id, review_id, url)
FROM '/Users/alexnorvani/SDC-Info/SDC/reviews_photos.csv'
DELIMITER ','
CSV HEADER;
