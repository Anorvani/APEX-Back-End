...
FROM '/Users/alexnorvani/SDC-Info/data/reviews.csv'
DELIMITER ','
CSV HEADER;
...
FROM '/Users/alexnorvani/SDC-Info/data/characteristics.csv'
DELIMITER ','
CSV HEADER;

COPY photos (photo_id, review_id, url)
FROM '/Users/alexnorvani/SDC-Info/data/reviews_photos.csv'
DELIMITER ','
CSV HEADER;
